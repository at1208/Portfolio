...
const SendMail = () => {
  return    <div className='  shadow container text-center u1 '>
      <img className='i1' src='sendmail.gif' alt=''/>
     <div className='container text-center '>
       ...
       <div  >
          ...
          <div className='container shadow l2 n1'><i className='fa fa-github' style={{ fontSize: '14px'}}/> <a href='https://github.com/at1208/sendMail'>https://github.com/at1208/sendMail</a></div>
       </div>

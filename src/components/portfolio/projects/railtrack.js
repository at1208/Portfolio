...
const RailTrack = () => {
  return <div className=' card  shadow container  text-center u1 '>
             <img className=' card i1' src='indianrailway.gif' alt=''/>
               ...
               <h1 className='v1'>RailTrack</h1>
                 ...
                 <div className='l3' >
                     ...
                     9 Jul 2019
                        ...
                        <div className='container   n1 l2'><i className='fa fa-github' style={{ fontSize: '14px'}}/> <a href='https://github.com/at1208/IndianRailway'>https://github.com/at1208/IndianRailway</a></div>
                 </div>

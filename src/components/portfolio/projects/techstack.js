...
const TechStack = () => {
  return     <div className=' card   shadow container  text-center u1 '>
                                <img className='  card   i1' src='techstack.gif' alt=''/>
                                  ...
                                  <h1 className='v1'>Techstack</h1>
                                    ...
                                    <div className='l3'>
                                        ...
                                        4 Jun 2019
                                           ...
                                           <div className='container   n1 l2'><i className='fa fa-github' style={{ fontSize: '14px'}}/> <a href='https://github.com/at1208/Techstack'>https://github.com/at1208/Techstack</a></div>
                                    </div>

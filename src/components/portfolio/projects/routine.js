...
const Routine = () => {
  return   <div className=' card  shadow container   text-center u1 '>
                  <img className=' card     i1' src='routine.gif' alt=''/>
                   ...
                   <h1 className='v1'>Routine</h1>
                     ...
                     <div className='l3'>
                         ...
                         16 Feb 2019
                            ...
                            <div className='container   n1 l2'><i className='fa fa-github' style={{ fontSize: '14px'}}/> <a href='https://github.com/at1208/Routine'>https://github.com/at1208/Routine</a></div>
                     </div>

...
const EventOrganiser = () => {
  return   <div className='  card shadow container   text-center u1 '>
      <img className='   card   i1' src='eventorganiser.gif' alt=''/>
      ...
      <h1 className='v1'>Event Organiser</h1>
        ...
        <div  className='l3'>
            ...
            21 May 2019
               ...
               <div className='container   n1 l2'><i className='fa fa-github' style={{ fontSize: '14px'}}/> <a href='https://github.com/at1208/EventOrganiser'>https://github.com/at1208/EventOrg</a></div>
        </div>

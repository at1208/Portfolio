...
const Calculator = () => {
  return     <div className='   shadow container  text-center u1 '>
                                <img className='    i1' src='calculator.gif' alt=''/>
                                  ...
                                  <h1 className='v1'>Calculator</h1>
                                    ...
                                    <div>
                                        ...
                                        2 Oct 2019
                                           ...
                                           <div className='container shadow n1 l2'><i className='fa fa-github' style={{ fontSize: '14px'}}/> <a href='https://github.com/at1208/Calculator'>https://github.com/at1208/Calculator</a></div>
                                    </div>

...
const SendSMS = () => {
  return   <div className='  card shadow container   text-center u1 '>
      <img className='  card    i1' src='sendSMS.gif' alt=''/>
      ...
      <h1 className='v1'>Send SMS</h1>
        ...
        <div  className='l3'>
            ...
            29 Oct 2019
               ...
               <div className='container   n1 l2'><i className='fa fa-github' style={{ fontSize: '14px'}}/> <a href='https://github.com/at1208/sendSMS'>https://github.com/at1208/sendSMS</a></div>
        </div>

...
const ChangeLang = () => {
  return <div className='  card shadow container   text-center u1 '>
                  <img className='   card  i1' src='changelang.gif' alt=''/>
                   ...
                   <h1 className='v1'>Change Lang</h1>
                     ...
                     <div className='l3' >
                         ...
                         24 May 2019
                            ...
                            <div className='container  n1 l2'><i className='fa fa-github' style={{ fontSize: '14px'}}/> <a href='https://github.com/at1208/LangSelector'>https://github.com/at1208/LangSelector</a></div>
                     </div>

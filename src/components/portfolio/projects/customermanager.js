...
const  CustomerManager = () => {
  return    <div className=' card  shadow container  text-center u1'>
      <img className=' card    i1' src='customerman.gif' alt=''/>
      ...
      <h1 className='v1'>Customer Manager</h1>
        ...
        <div className='l3'>
            ...
            12 Oct 2019
               ...
               <div className='container   n1 l2'><i className='fa fa-github' style={{ fontSize: '14px'}}/> <a href='https://github.com/at1208/CustomerManager'>https://github.com/at1208/Customer</a></div>
        </div>

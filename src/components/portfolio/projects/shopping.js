...
const Shopping = () => {
  return    <div className=' card  shadow container  text-center u1'>
      <img className=' card    i1' src='shopping .gif' alt=''/>
      ...
      <h1 className='v1'>Shopping</h1>
        ...
        <div className='l3'>
            ...
            31 May 2019
               ...
               <div className='container  n1 l2'><i className='fa fa-github' style={{ fontSize: '14px'}}/> <a href='https://github.com/at1208/Shopping'>https://github.com/at1208/Shopping</a></div>
        </div>
